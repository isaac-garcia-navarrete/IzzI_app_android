...
class IsaacCopyWidget extends StatefulWidget {
  const IsaacCopyWidget({Key key}) : super(key: key);

  @override
  _IsaacCopyWidgetState createState() => _IsaacCopyWidgetState();
}

class _IsaacCopyWidgetState extends State<IsaacCopyWidget> {
