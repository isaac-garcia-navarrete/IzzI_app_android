...
class MiredWidget extends StatefulWidget {
  const MiredWidget({Key key}) : super(key: key);

  @override
  _MiredWidgetState createState() => _MiredWidgetState();
}

class _MiredWidgetState extends State<MiredWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        backgroundColor: Color(0xFFEC652B),
                ...
                child: ListView(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Image.network(
                          'https://comparaiso.mx/sites/comparaiso.mx/files/styles/article_hero/public/images/izzi-100-megas-825x293_0.png?itok=JyLJYS11',
                          fit: BoxFit.cover,
                        ),
                        Text(
                          'IzzI',
